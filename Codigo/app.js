...
function AdicionaVideo(){
    if (largura < 720) {
        ...
        var video = `<iframe id="player" width="600" height="330" src="https://www.youtube.com/embed/Hz8Ql8cMj4U?si=Ws1M84cAOQehcg8o&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <p class="video__texto"> Conheça um pouco sobre nós!!!</p>`
    }
    $("#video").html(video);
